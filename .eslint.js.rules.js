...
const POSSIBLE_PROBLEMS = {
   ...
   */
  // 'array-callback-return': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
   ...
   */
  'no-unused-vars': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
...
const SUGGESTIONS = {
   ...
   */
  'accessor-pairs': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
   ...
   */
  'curly': [
    ESLINT_ERROR_LEVEL.DEFAULT, 'multi-line',
  ],
  /*
  ...
  /*
   * Disallow `parseInt()` and `Number.parseInt()` in favour of binary, octal,
  ...
  /*
   * Disallow use of the `RegExp` constructor in favour of regular expression
   * literals
   */
...
const LAYOUT_AND_FORMATTING = {
   ...
   */
  // 'array-bracket-spacing': [ESLINT_ERROR_LEVEL.DEFAULT,'never'],
  /*
   ...
   */
  // 'max-len': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
