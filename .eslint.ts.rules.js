...
const SUPPORTED_RULES = {
   ...
   */
  '@typescript-eslint/no-duplicate-enum-values': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
   ...
   */
  '@typescript-eslint/prefer-enum-initializers': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
   ...
   */
  '@typescript-eslint/prefer-literal-enum-member': ESLINT_ERROR_LEVEL.DEFAULT,
  /*
  ...
  */
  ...
  //      ESLINT_ERROR_LEVEL.DEFAULT,
  /*
   * Disallow certain triple slash directives in favour of ES6-style import
   * declarations
   */
